...
[![Tests](https://img.shields.io/badge/tests-51%20passing-64e6bd?style=flat-square&labelColor=0b141c)](#verification-matrix)
...
|---|---:|---|
| Backend | 37 tests | `cd backend && python -m pytest` |
